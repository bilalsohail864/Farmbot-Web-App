...
export class NavBar extends React.Component<NavBarProps, Partial<NavBarState>> {
  ...
  ConnectionStatus = () => {
    ...
    // const baal_connectivity_button = {
    //   border: "1px solid";
    //   padding: "3px";
    //   margin: "10px";
    //   border-radius: "5px";
      ...
      {/* <b>Connectivity</b> */}
        <Popover position={Position.BOTTOM_RIGHT}
          ...
          target={
            ...
            // ?
            <b style={{ border: "1px solid", padding: "3px", margin: "10px", borderRadius: "5px" }}>CONNECTIVITY <DiagnosisSaucer {...data.flags}
  ...
  render() {
    ...
    return <ErrorBoundary>
      <div className={[
        ...
        <nav role="navigation" style={{paddingBottom:"10px"}}>
